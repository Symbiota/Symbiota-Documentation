...
This page describes how to use the two taxonomic cleaning tools in Symbiota portals. For more information about the taxonomic thesaurus, visit the [Taxonomy](/docs/Editor_Guide/taxonomic_thesaurus) page.

:::

Navigate to these tools through the ***,Administration Control Panel (My Profile > Occurrence Management > name of collection)***. Click ***Data Cleaning Tools***, then view the box below the ***Taxonomy*** header.
