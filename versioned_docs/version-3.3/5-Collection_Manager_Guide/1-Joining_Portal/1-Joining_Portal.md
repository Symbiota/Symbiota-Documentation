...
Click the button below to find a list of active Symbiota portals. You will want to select a Symbiota portal that matches the scope of your data. You can add your data to a Symbiota portal as a "live" collection or a "snapshot" (see [this page](/Collection_Manager_Guide/Joining_Portal/management_types) for more information about management types in Symbiota portals).

<Button label="List of Symbiota Portals" link="https://symbiota.org/symbiota-portals/" />

<Button label="Request to Join a Symbiota Portal" link="https://docs.google.com/forms/d/e/1FAIpQLSf-QywdugIAAxzBLkoKX8er-JkW06Rv4C_Rkm2efPiryTHLGw/viewform" />
