...
![Generate Loan Paperwork](/img/generateloanpaperwork2026.png)
...
To edit an outgoing loan or link specimens to the loan in the future, navigate to the “Outgoing Loans” tab and click the pencil icon next to the loan identifier (see below).

![Edit Loan](/img/editloan2026.png)
