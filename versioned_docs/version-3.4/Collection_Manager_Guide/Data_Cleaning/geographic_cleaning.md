...
![Geographic Distribution Viewer](/img/geographicdistribution2026.png)
...
![Geography Cleaning Tool](/img/geocleaningtool2026.png)

This tool will also check whether there are records that lack data in the country, state/province, or county fields, yet have geographic data in other fields. For example, the line "Null country with non-Null state" lists all records that do not have a country value in the specimen record even though there is a state or province listed in the state/province field of that record. You can click "[number] Records" and assign a higher geographic value to those records (see example below).

![Geography Cleaning Tool Example](/img/geocleaningexample2026.png)
